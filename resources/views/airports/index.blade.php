...
<div class="row">
    ...
    @foreach ($airports as $airport)
    	<div class="col-md-3 fade-in three airportimglist" style="background-image: url('{{ $airport->imglink }}')"><a href="/airports/{{ $airport->slug}}"><span>{{ $airport->title }}<br />({{ $airport->code }})</span></a>
